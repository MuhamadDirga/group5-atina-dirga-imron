...
<div class="col-sm-9">
	...
	<?php echo form_open('Aktifitas/Donasi/Update/'.$this->uri->segment(4)); ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="date" name="tanggal" value="<?php echo $getData->tanggal?>" id="tanggal" class="form-control"><br>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="jumlah" value="<?php echo $getData->jumlah?>" id="nama" class="form-control" placeholder="Jumlah"><br>
		</div>
	</div>
